...
ALTER SEQUENCE dept3_seq MAXVALUE 9999; --최대치 수정
ALTER SEQUENCE dept3_seq INCREMENT BY -1; --증가값 변경
ALTER SEQUENCE dept3_seq MINVALUE 0;

-- 시퀀스 값을 다시 처음으로 돌리는 방법
SELECT dept3_seq.CURRVAL FROM dual;
ALTER SEQUENCE dept3_seq INCREMENt BY - 15;
SELECT dept3-seq.NEXTVAL FROM dual;
